...
VERSION = "0.8.58"
NOTES = "Bản cập nhật v0.8.58: Tối ưu hóa triệt để giọng đọc thuyết minh (Continuous Flow Narration) khi cắt ráp video highlight recap hoặc xuất từ timeline, loại bỏ hoàn toàn các khoảng trống ngắt quãng lâu giữa các phân cảnh, đồng bộ nhịp thở tự nhiên 0.3s mượt mà liền mạch."
...
# Update update.ps1 and update.bat on server
