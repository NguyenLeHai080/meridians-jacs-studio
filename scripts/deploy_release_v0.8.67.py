...
VERSION = "0.8.67"
NOTES = "Bản cập nhật v0.8.67: Bổ sung tính năng Đan tiếng gốc (giữ âm thanh hiện trường 20% dưới nền Voice AI), Hook cao trào giữ nguyên tiếng gốc cảnh mở màn, Nhạc nền tự né (Auto-Ducking), và chuẩn hóa nhịp cắt Tight-Cut loại bỏ khoảng lặng chết."
