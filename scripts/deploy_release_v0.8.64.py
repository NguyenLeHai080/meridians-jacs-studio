...
VERSION = "0.8.64"
NOTES = "Bản cập nhật v0.8.64: Sửa lỗi phụ đề không chạy theo giọng đọc; Đồng bộ động hiển thị phụ đề và hiệu ứng Karaoke sáng từng từ theo thời gian thực (Real-time Karaoke Highlight) khớp 100% với giọng đọc Voice TTS xuyên suốt các phân cảnh trên Timeline."
