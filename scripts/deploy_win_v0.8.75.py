...
VERSION = "0.8.75"
NOTES = "Bản cập nhật v0.8.75 (Windows): Bộ cài đặt chuẩn Windows x64 (NSIS Setup .exe) & Bản nén Portable (.zip); Khắc phục triệt để lỗi hiển thị kịch bản và phân cảnh Timeline Studio; Chuẩn hóa luồng hàng đợi: Bảng \"Nguồn Video Từ Timeline\" chỉ nạp video hoàn tất từ Timeline; Tách biệt 100% bản ghi render với video nguồn gốc để chống xóa nhầm; Tối ưu xuất video hàng loạt tuần tự bảo vệ RAM và chống đơ máy."
