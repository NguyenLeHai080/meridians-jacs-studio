...
RELEASE_NOTES = f"Bản cập nhật v{VERSION}: Tự động cấu hình và tải FFmpeg/FFprobe cho Render Engine, đồng bộ timeline 60fps & voiceover mượt mà."
...
print("\n🔍 Kiểm tra phản hồi từ API Server (Check update API cho v0.8.19)...")
stdin, stdout, stderr = ssh.exec_command("curl -s 'http://127.0.0.1:84/api/v1/releases/check?platform=windows&current_version=v0.8.19&channel=stable'")
