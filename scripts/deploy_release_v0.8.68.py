...
VERSION = "0.8.68"
NOTES = "Bản cập nhật v0.8.68: Tùy chọn Tắt Voice AI review (Pure Highlights & Clip Sequence Mode - phân tích và ghép chuỗi cảnh hành động/kịch tính giữ 100% âm thanh gốc); Tính năng Tách/Lọc bỏ nhạc nền gốc của video (Vocal & SFX Stem Isolation) giúp khử nhạc nền phim/bản quyền, giữ trọn vẹn lời thoại nhân vật, còi hú cảnh sát và âm thanh hiện trường; Đồng bộ chuẩn xác thời lượng phân cảnh theo độ dài clip thực tế."
