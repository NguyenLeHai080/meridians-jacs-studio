...
VERSION = "0.8.59"
NOTES = "Bản cập nhật v0.8.59: Sửa triệt để lỗi phân tích Anh - Việt lẫn lộn, đảm bảo kịch bản và phân cảnh 100% tiếng Việt thuần túy; Đồng bộ thời gian thực lời thoại với giọng đọc AI khi chỉnh sửa phân cảnh trong Timeline Inspector và Video Analysis."
