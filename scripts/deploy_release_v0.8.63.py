...
VERSION = "0.8.63"
NOTES = "Bản cập nhật v0.8.63: Chuẩn hóa tốc độ đọc (3.65 từ/giây) đồng bộ tuyệt đối giữa giọng nói Voice TTS và hiệu ứng Karaoke phụ đề; Triệt tiêu hoàn toàn độ trễ/chờ đợi cuối phân cảnh trước khi chuyển cảnh tiếp theo."
