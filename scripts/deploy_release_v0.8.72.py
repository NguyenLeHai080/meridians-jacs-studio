...
VERSION = "0.8.72"
NOTES = "Bản cập nhật v0.8.72: Sửa triệt để bóc tách 100% nhạc nền gốc (True AI Stem Separation & HPSS) trong cả Trình phát trực tiếp (Live Preview) và Xuất Render Video thành phẩm. Bảo toàn hoàn toàn tiếng thoại, còi hú, tiếng súng & hiện trường."
...
# Copy voice_worker.py to local voice-runtime
