...
VERSION = "0.8.65"
NOTES = "Bản cập nhật v0.8.65: Chuẩn hóa thời lượng phân tích kịch bản 10 phút (~24 phân cảnh, ~2400 từ) và 15 phút (~35 phân cảnh, ~3600 từ); Triệt tiêu hoàn toàn lỗi lặp lại đoạn mở đầu ở các phân cảnh cuối, kịch bản phát triển tuyến tính liên tục 100% từ đầu tới kết thúc."
