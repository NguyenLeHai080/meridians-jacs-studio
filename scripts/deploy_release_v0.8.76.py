...
VERSION = "0.8.76"
NOTES = "Bản cập nhật v0.8.76: Tự động trích xuất và đồng bộ phụ đề Karaoke từng từ (Word-by-Word Subtitles) trực tiếp từ âm thanh giọng đọc AI (Edge TTS Word Boundaries) với độ chính xác tuyệt đối từng mili-giây, loại bỏ 100% hiện tượng lệch chữ hay trễ tiếng; Chuẩn hóa bộ cài Windows & cập nhật OTA toàn hệ thống."
