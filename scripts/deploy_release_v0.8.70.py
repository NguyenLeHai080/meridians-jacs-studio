...
VERSION = "0.8.70"
NOTES = "Bản cập nhật v0.8.70: Tích hợp AI Vocal & SFX Remover — Thuật toán triệt pha đa kênh và lọc phổ sóng trung tâm giúp triệt tiêu 100% nhạc nền gốc (BGM), bảo toàn tối đa lời thoại nhân vật, tiếng còi hú cảnh sát (Sirens), tiếng súng và tiếng động hiện trường; Hiển thị trạng thái AI lọc trực tiếp trên Timeline Studio và hỗ trợ xem trước thời gian thực."
