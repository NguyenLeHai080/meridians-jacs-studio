...
VERSION = "0.8.60"
NOTES = "Bản cập nhật v0.8.60: Khắc phục triệt để lỗi voice và phụ đề bị gom 1 cục ở đầu timeline; Tự động căn khớp 1:1 đồng thời từng phân cảnh Visuals, Voice và Phụ đề trải đều chuẩn xác theo toàn bộ dòng thời gian dựng video; Tối ưu hóa phân tích kịch bản recap không bị lặp câu chữ."
