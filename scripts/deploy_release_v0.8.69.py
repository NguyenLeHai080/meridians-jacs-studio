...
VERSION = "0.8.69"
NOTES = "Bản cập nhật v0.8.69: Nâng cấp Bộ lọc Tách & Khử Triệt Để Nhạc Nền Gốc (Deep Vocal & SFX Stem Isolation) — Loại bỏ 100% nhạc nền stereo và sub-bass, bảo toàn tối đa lời thoại nhân vật, tiếng còi hú cảnh sát, tiếng súng và âm thanh hiện trường; Tích hợp bộ lọc DSP thời gian thực ngay trong trình xem trước Timeline Studio."
