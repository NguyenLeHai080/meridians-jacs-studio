...
VERSION = "0.8.61"
NOTES = "Bản cập nhật v0.8.61: Tối ưu hóa bộ lọc làm sạch tên video (loại bỏ Save YouTube, ID rác); Đổi mới hệ thống phân tích kịch bản đa dạng 14 hồi kịch tính không lặp từ; Khắc phục triệt để lỗi âm thanh TTS bị gián đoạn/mất tiếng do ký tự đặc biệt; Nâng cấp truyền file script UTF-8 cho bộ đọc giọng nói edge-tts."
