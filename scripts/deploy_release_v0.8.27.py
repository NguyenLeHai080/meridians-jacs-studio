...
RELEASE_NOTES = f"Bản cập nhật v{VERSION}: Bổ sung Bảng Danh Sách Model AI & Định Giá Được Cấp Phép Từ Cloud Admin, nút Cập nhật bảng giá & Đồng bộ Providers BYOK thời gian thực."
...
print("\n🔍 Kiểm tra phản hồi từ API Server (Check update API cho v0.8.26)...")
stdin, stdout, stderr = ssh.exec_command("curl -s 'http://127.0.0.1:84/api/v1/releases/check?platform=windows&current_version=v0.8.26&channel=stable'")
