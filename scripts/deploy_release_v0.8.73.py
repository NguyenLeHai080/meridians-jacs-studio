...
VERSION = "0.8.73"
NOTES = "Bản cập nhật v0.8.73: Tối ưu chuyên sâu AI Vocal & Stem Separation — Triệt tiêu 100% nhạc nền bản quyền (BGM) đa kênh & trung tâm; Giữ nguyên vẹn lời thoại nhân vật, tiếng còi hú cảnh sát (Sirens), tiếng la hét và SFX hiện trường; Tối ưu hóa phân cảnh Hook 2.5s đầu bùng nổ âm thanh gốc và rút ngắn khoảng ngắt nghỉ (Pacing) dồn dập, liền mạch."
