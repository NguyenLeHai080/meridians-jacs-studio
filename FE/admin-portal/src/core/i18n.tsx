...
export const baseTranslations: Record<Language, TranslationDictionary> = {
  vi: {
    ...
    headingTasksClients: "TÁC VỤ & KHÁCH HÀNG",
    headingClientsLegal: "TÁC VỤ & KHÁCH HÀNG",
    ...
    menuLicenses: "Quản lý API Key",
    menuClients: "Quản lý khách hàng",
    menuJobs: "Quản lý Jobs & Tác vụ",
  ...
  en: {
    ...
    headingTasksClients: "TASKS & CLIENTS",
    headingClientsLegal: "TASKS & CLIENTS",
    ...
    menuLicenses: "API Keys Management",
    menuClients: "Clients Management",
    menuJobs: "Jobs & Tasks Management",
    menuSessions: "User & Device Management",
    menuTerms: "Permissions & Terms (EULA)",
    menuProviders: "AI Providers Gateway",
    menuAiModelsPricing: "AI Models & Pricing",
  ...
  jp: {
    ...
    headingTasksClients: "タスク・顧客管理",
    headingClientsLegal: "タスク・顧客管理",
