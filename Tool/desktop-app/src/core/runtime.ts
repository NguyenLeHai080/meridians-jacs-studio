...
const fallbackInfo: MachineInfo = { machineId: "WEB-DEMO-MACHINE", machineIdSource: "browser-demo", platform: "linux", arch: "x64", appVersion: "0.3.3" };
