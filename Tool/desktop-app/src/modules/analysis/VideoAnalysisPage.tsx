...
export function VideoAnalysisPage({ onAddJob }: { onAddJob?: (job: Job) => void }) {
  ...
  const availableProviders = providers.filter((provider) => provider.enabled && provider.hasApiKey && provider.capabilities.includes("analysis"));
