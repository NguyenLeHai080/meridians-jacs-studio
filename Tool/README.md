...
`JACS Studio-0.3.2-arm64.dmg`/`.zip`, macOS Intel
`JACS Studio-0.3.2.dmg`/`.zip` và Windows x64
`JACS Studio Setup 0.3.2.exe`. Windows x64 được build trên Windows runner của
